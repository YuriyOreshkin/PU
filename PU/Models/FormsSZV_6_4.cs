...
namespace PU.Models
{
    ...
    public partial class FormsSZV_6_4
    {
        ...
        public byte TypeContract { get; set; }
        ...
        public Nullable<decimal> s_3_2 { get; set; }
        public Nullable<decimal> d_0_0 { get; set; }
        public Nullable<decimal> d_0_1 { get; set; }
        public Nullable<decimal> d_1_0 { get; set; }
        public Nullable<decimal> d_1_1 { get; set; }
        public Nullable<decimal> d_2_0 { get; set; }
        public Nullable<decimal> d_2_1 { get; set; }
        public Nullable<decimal> d_3_0 { get; set; }
        public Nullable<decimal> d_3_1 { get; set; }
        ...
        public Nullable<decimal> SumPayPFR_Strah_D { get; set; }
        public Nullable<decimal> SumFeePFR_Nakop_D { get; set; }
        public Nullable<decimal> SumPayPFR_Nakop_D { get; set; }
