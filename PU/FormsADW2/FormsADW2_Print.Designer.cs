namespace PU.FormsADW2
{
    partial class FormsADW2_Print
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Предварительный просмотр Формы АДВ-2";
            this.ThemeName = "Office2013Light";
            this.Load += new System.EventHandler(this.FormsADW2_Print_Load);
