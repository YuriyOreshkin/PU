...
namespace PU
{
    ...
    public class ChangeScriptBuilder
    {
            ...
            Dictionary<SchemaObject, Dictionary<string, SQLiteDdlStatement>> dstSchema)
        {
            ...
            if (Classes.Utils.AlterTableIsPossible(orig, stmt, ref added))
            {
            ...
            else
            {
                ...
                string tmpname = Classes.Utils.GetTempName(stmt.ObjectName.ToString());
                ...
                List<SQLiteColumnStatement> common = Classes.Utils.GetCommonColumns(origTable, updTable, false, out diffcols);
                ...
                if (common.Count > 0)
                {
                    ...
                    {
                        if (!Classes.Utils.ColumnListContains(common, c))
                            ncols.Add(c);
                    } // foreach
                    ...
                    string selectlist = Classes.Utils.BuildColumnsString(common, false);
                    ...
                    if (ncols.Count > 0)
                        extralist = "," + Classes.Utils.BuildNullableOrNonNullConstantDefaultSelectList(ncols);
                    ...
                    {
                        if (ncols.Count > 0)
                            allCols = selectlist + "," + Classes.Utils.BuildColumnsString(ncols, false);
                        else
                            allCols = selectlist;
                    }
                    else
                        allCols = Classes.Utils.BuildColumnsString(ncols, false);
            ...
            Dictionary<SchemaObject, Dictionary<string, SQLiteDdlStatement>> dstSchema)
        {
            ...
            if (Classes.Utils.TableIndexesWereChanged(stmt.ObjectName.ToString(), srcSchema[SchemaObject.Index], dstSchema[SchemaObject.Index],
            ...
            if (Classes.Utils.TableTriggersWereChanged(stmt.ObjectName.ToString(), srcSchema[SchemaObject.Trigger], dstSchema[SchemaObject.Trigger],
