namespace PU.FormsADW1
{
    partial class FormsADW1_Print
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Text = "Предварительный просмотр Формы АДВ-1";
            this.ThemeName = "Office2013Light";
            this.Load += new System.EventHandler(this.FormsADW1_Print_Load);
